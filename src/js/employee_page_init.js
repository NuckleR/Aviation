...
function search_init(){
    ...
    $.ajax({
        ...
        success: function(obj){
            ...
            let html = "";
            html+=`<option selected disable id="...">...</option>`

            if(obj['departments']!=null){
                for(i=0; i < obj['departments'].length; i++){
                    html+=
                    `<option id="${obj['departments'][i]['name']}">${obj['departments'][i]['name']}</option>`;
                }
            }
            ...
            if(obj['specialities']!=null){
                for(i=0; i < obj['specialities'].length; i++){
                    html+=
                    `<option id="${obj['specialities'][i]['name']}">${obj['specialities'][i]['name']}</option>`;
                }
            }
...
function table_init(){
    ...
    $.ajax({
        url: 'php/load_employee_table.php',
        method: 'post',
        dataType: 'json',
        data: params,
        success: function(obj){
            ...
            for(i=0; i <obj['locations'].length; i++){
                ...
                `<tr>
                    <td colspan="4" style="background: #F37777; border: 1px solid #EC2D2D; color: #EBEBEB;">
                        <a class="btn col-12 p-0" data-bs-toggle="collapse" 
                        data-bs-target="#row_loc_${i}" style="color: #EBEBEB;"
                        aria-expanded="false" aria-controls="row_loc_${i}">${obj['locations'][i]['name']}</a>
    
                        <div class="collapse" id="row_loc_${i}">
                            <div class="card card-body g-3" style="background: #F37777;">
                                <div class="col-md-4 mx-auto">
                                    <svg id="${obj['locations'][i]['id']}" class="add_emp_but" width="15" 
                        ...
                        obj['locations'][i]['id'])
                    {
                        ...
                        `<tr>
                            <td colspan="4" style="background: #EEE2A3; border: 1px solid #978D5C; color: #212529;">
                                ...
                                <div class="collapse" id="row_dep_${j}">
                                    <div class="card card-body" style="background: #EEE2A3; ">
                                        <div class="col-md-4 mx-auto row g-3">
                                            <div class="col-md-4 mx-auto">
                    ...
                    for(k=0; k < obj['employees'].length; k++){
                            ...
                            obj['locations'][i]['id'])
                        {
                            ...
                            `<tr>
                                ...
                                <td class="col-md-3">
                                    <div class="row g-3 mx-auto pt-2 pb-2">
                                        <svg id="${obj['employees'][k]['id']}" class="info_icon col-md-6" width="20" 
                                            height="20" viewBox="0 0 45 45" fill="none" 
                                            data="icons/emp_info_icon.svg"
                                            style="cursor:pointer"
                                            onclick="employee_info(this)"
