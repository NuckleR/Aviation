...
function search_init(){
    ...
    $.ajax({
        ...
        success: function(obj){
            ...
            let html = "";
            html+=`<option selected id="...">...</option>`
...
function table_init(){
    ...
    $.ajax({
        ...
        success: function(obj){
            ...
            //                 html += 
            //                 `<tr>
            //                     <td class="col-md-4">${obj['employees'][k]['surname']} ${obj['employees'][k]['name']} ${obj['employees'][k]['patronymic']}</td>
            //                     <td class="col-md-2">${obj['employees'][k]['rank']}</td>
            //                     <td class="col-md-3">${obj['employees'][k]['speciality']}</td>
            //                     <td class="col-md-3">
            //                         <div class="row g-3 mx-auto pt-2 pb-2">
            //                             <svg id="${obj['employees'][k]['id']}" class="info_icon col-md-4" width="30" 
            //                                 height="30" viewBox="0 0 45 45" fill="none" 
