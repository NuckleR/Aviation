...
<head>
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom sticky-top"
        ...
        <li class="nav-item"><a href="#" class="nav-link  active">Строевая</a></li>
        </ul>
...
<body class="transition-fade d-flex flex-column min-vh-100" onload="init()">
    ...
    <form class="row g-3 mx-auto col-8 pb-3 justify-content-center d-flex">
        ...
        <div class="row g-3 col-12 justify-content-center d-flex">
            <div class="row d-flex justify-content-center col-3">
                <label for="date" class="form-label">Дата</label>
                <input type="date" id="date" class="form-control" 
                    placeholder="Выберите дату" value="">
            </div>
        </div>
    ...
    <script type="text/javascript" src="js/Combatant/combatant_page_init.js"></script>
    <script type="text/javascript" src="js/Combatant/search.js"></script>
